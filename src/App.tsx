    ...
    <div className="container-fluid">
      <div className="row py-1">
        <div className="col-12">
          ...
          <a
            href="https://www.instagram.com/waterlooconcretecanoe/"
...
function App() {
  return (
    <div className="App" style={{ overflowX: "hidden" }}>
        ...
        <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
          <div className="d-flex justify-content-between">
            <Link to={"/"} className="navbar-brand ms-3">
              <img
                src={Logo}
                alt="uWaterloo Concrete Canoe Logo"
                width="54"
                height="44"
              />
            </Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <Link to={"past-canoes"} className="nav-link">
                    Past Canoes
                  </Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <Link to={"subteams"} className="nav-link">
                    Subteams
                  </Link>
                </li>
                <li className="nav-item">
      ...
      <Outlet />
      <footer
        className="App-footer bg-dark text-center text-white"
        // TODO: make footer height 100px larger to fit sponsor carousel
        style={{ height: "80px" }} 
      >
        <Footer />
      </footer>
